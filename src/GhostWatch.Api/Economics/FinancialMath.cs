...
{
    public static decimal? Cost(decimal? input, decimal? other) => input + other;
    public static decimal? Profit(decimal? input, decimal? other, decimal? revenue) => revenue - Cost(input, other);
