...
@Component({
  ...
  template: `
    ...
    <section class="panel"><h2>Workspace setup</h2><p>Track planning and EVE character connections are ready. Capital allocations, Runs and historical reporting are next in development.</p>
